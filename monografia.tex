...
\def\@makechapterhead#1{%
  ...
  \parbox[b]{\textwidth}{%
    ...
    \parbox[t]{\textwidth-7ex-1ex}%
      ...
      {\MakeUppercase{#1}}}%
    \vspace*{2.4cm}%espaco entre o nome do capitulo e subsection
    }\\[2pt]%
  }%
}
...
No texto da apresentação, aborde o tema do trabalho iniciando por uma
discussão ampla do conteúdo, até tratar especificamente o que vai ser
desenvolvido.
